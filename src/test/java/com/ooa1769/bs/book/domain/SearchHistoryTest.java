...
public class SearchHistoryTest {
    ...
    public void setup() {
        ...
        member = new Member(1L, "ooa1769@naver.com", "손예진", "1234", true);
    ...
    public void 검색_목록_추가_삭제() {
        ...
        assertThat(histories).contains(sameKeywordOrderHistory);
        ...
        member.removeHistory(sameKeywordOrderHistory);
        assertThat(histories).doesNotContain(sameKeywordOrderHistory);
        assertThat(histories).size().isEqualTo(1);
    }
    ...
    public void 동일한_키워드_검색시_날짜갱신() {
        ...
        assertThat(history.getSearchDate()).isEqualTo(orderDate);
